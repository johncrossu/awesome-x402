...
- [x402stock](https://x402stock.vercel.app) - Real-time US stock market data for AI agents. 23 pay-per-call endpoints: quotes, snapshots, OHLC aggregates, company fundamentals, dividends, splits, corporate events, market news, top gainers/losers, whole-market grouped daily, and technical indicators (SMA/EMA/RSI/MACD). $0.01–$0.03 USDC per call on Base via x402 — no API keys, no accounts. [OpenAPI](https://x402stock.vercel.app/openapi.json) | [llms.txt](https://x402stock.vercel.app/llms.txt)
