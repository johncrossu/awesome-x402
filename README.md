...
- **[J-sey Data API](https://johncross-data-api.johncrossugwuegede.workers.dev)** — 18-endpoint pay-per-call data API on Base: wallet lookups, web scraping, crypto prices, DeFi yields, and more. $0.002/call USDC. Bazaar-listed. ([OpenAPI](https://johncross-data-api.johncrossugwuegede.workers.dev/openapi.json))
